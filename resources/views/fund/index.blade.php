        ...
        <div class="d-flex gap-2">
            ...
            @else
                <button class="btn btn-secondary btn-sm" disabled>
                    <i class="bi bi-printer me-1"></i> <strong>No Template</strong>
                </button>
            @endif
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover mb-0">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted">No fund records found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <form class="modal-content" method="POST" action="{{ route('fund.store') }}">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="fund_description" required>
                </div>
            </div>
