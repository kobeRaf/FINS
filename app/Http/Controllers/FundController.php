...
class FundController extends Controller
{
    public function view()
    {
        ...
        $template = Report::first(); // or whatever logic you want
        return view('fund.fund', compact('funds', 'template'));
    }
    ...
    {
        $funds = Fund::latest()->get();
        $template = Report::first(); // or however you're managing templates
